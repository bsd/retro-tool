...
var Room = function Room(_ref) {
    ...
    return React.createElement("div", { className: "Room" }, React.createElement("header", null, React.createElement("h2", null, room.name), (!editRoom || editRoom.id !== room.id) && React.createElement(Input_1.Button, { label: "Edit Room", onClick: function onClick() {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        ...
        selectVisitRoom: function selectVisitRoom(roomId, user) {
            return data_1.selectVisitRoom(dispatch)(roomId, user);
        }
    };
};
